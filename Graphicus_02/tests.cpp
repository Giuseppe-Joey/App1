...
void Tests::tests_application_cas_02()
{
   ...
   std::cout <<"PLAN DE TESTS"<<endl;
   std::cout << endl;
   std::cout << "*****************************************************" << endl;
   std::cout << "Affichage de la couche avec valeurs negatives entrees" << endl;
   std::cout << "*****************************************************" << endl;
   ...
   std::cout <<"l'aire totale de la couche est : " <<ca.aire() <<endl;
   std::cout << endl;
   std::cout << endl;
   
   std::cout << "*******************************************************************" << endl;
   std::cout << "Les trois prochains tests retourne 1 si vrai et 0 si erreur d'index" << endl;
   std::cout << "*******************************************************************" << endl;
   std::cout << "Retrait d'une forme du canevas a un index inexistant : " << ca.retirerForme(5) << endl;
   std::cout << "Activation d'une couche a un index inexistante : " << ca.activerCouche(6) << endl;
   std::cout << "Cacher une couche a un index inexistant : " << ca.cacherCouche(6) << endl;
   std::cout << "*******************************************************************" << endl;
   std::cout << endl;
   ...
   std::cout << "****************************************************************************" << endl;
   std::cout << "Les deux prochains tests retirent et vont chercher une forme dans un vecteur" << endl;
   std::cout << "--retourne 1 si vrai et 0 si erreur d'index" << endl;
   std::cout << "****************************************************************************" << endl;
   std::cout << "Retrait d'une forme dans un vecteur a un index inexistant : " << v1.retrait(7) << endl;
   std::cout << "Obtenir une forme dans un vecteur a un index inexistant : " << v1.obtenir(8) << endl;
   std::cout << "****************************************************************************" << endl;
   
  
   
   
   std::cout << "FIN DU PLAN DE TESTS" << endl;
